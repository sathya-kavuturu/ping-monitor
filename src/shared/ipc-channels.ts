...
export const IpcChannels = {
  ...
  HopHistoryRangeList: 'hop-history:range-list',
  DbStorageStats: 'db:storage-stats',
  DbExport: 'db:export',
  DbImport: 'db:import',
  DbImportedInfo: 'db:imported-info',
  DbImportedClear: 'db:imported-clear',
  DbImportedTargetsList: 'db:imported-targets-list',
  DbImportedPingHistoryList: 'db:imported-ping-history-list',
