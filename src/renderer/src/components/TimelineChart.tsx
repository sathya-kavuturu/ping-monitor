 ...
 *
 * Every lost ping (a `null` latency sample, or a rollup bucket with
 * `lostCount > 0`) draws as a thin red vertical bar across the full chart
 * height (see `drawLossMarkers`, shared with the Overview tab's charts) -
 * the hard-to-miss signal for "a packet was lost right here".
 */
